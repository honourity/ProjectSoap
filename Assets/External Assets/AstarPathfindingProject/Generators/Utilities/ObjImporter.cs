...
namespace Pathfinding {
   public class ObjImporter {
      private struct meshStruct {
         ...
         public meshStruct(Vector3[] vertices, Vector3[] normals, Vector2[] uv, Vector2[] uv1, Vector2[] uv2, int[] triangles, int[] faceVerts, int[] faceUVs, Vector3[] faceData, string name, string fileName)
         {
